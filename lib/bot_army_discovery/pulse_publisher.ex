defmodule BotArmyDiscovery.PulsePublisher do
  @moduledoc """
  Periodic health publisher for Discovery Bot.
  ...
  2. **`bot.discovery.pulse`** — richer metrics every 30 minutes (lower NATS volume).
  ...
  @envelope_source "bot_army_discovery"
  ...
  @impl true
  def init(_opts) do
    Logger.info("[PulsePublisher] Starting Discovery Bot pulse publisher")
