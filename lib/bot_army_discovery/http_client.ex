defmodule BotArmyDiscovery.HTTPClient do
  @moduledoc """
  ...
  Pass http_client as an option in init:
      def init(opts) do
        http_client = Keyword.get(opts, :http_client, BotArmyDiscovery.HTTPClient.Req)
...
defmodule BotArmyDiscovery.HTTPClient.Req do
  @moduledoc """
  Real HTTP client implementation using the Req library.
  """

  @behaviour BotArmyDiscovery.HTTPClient
