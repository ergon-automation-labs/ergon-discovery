defmodule BotArmyDiscovery.Skills.Example do
  @moduledoc """
  Example skill for Discovery Bot.
  ...
  1. NATS message arrives on trigger subject: `bot.bot_army_discovery.command.example`
  ...
  5. Result published to response subject: `bot.bot_army_discovery.response.<request_id>`
  ...
  1. Rename: `lib/bot_army_discovery/skills/your_skill.ex`
  ...
  def nats_triggers do
    ...
    [
      "bot.bot_army_discovery.command.example"
    ]
  end
